...
const CompleteProfile: React.FC = () => {
    ...
    }, [isProfileUpdated, router]); // Añade `router` aquí
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full">
            ...
            >
                <div className="mb-5">
                    <label htmlFor="age" className="block mb-2 text-sm font-bold text-gray-900">Edad</label>
                    <input
                        type="number"
                        id="age"
                        name="age"
                ...
                <div className="mb-5">
                    <label htmlFor="phone" className="block mb-2 text-sm font-bold text-gray-900">Teléfono</label>
                    <input
                        type="number"
                        id="phone"
                        name="phone"
                ...
                <div className="mb-5">
                    <label htmlFor="city" className="block mb-2 text-sm font-bold text-gray-900">Ciudad</label>
                    <input
                        type="text"
                        id="city"
                        name="city"
                ...
                <div className="mb-5">
                    <label htmlFor="address" className="block mb-2 text-sm font-bold text-gray-900">Dirección</label>
                    <input
                        type="text"
                        id="address"
                        name="address"
                        ...
                        required
                    />
                    {error.address && <span className="text-red-600">{error.address}</span>}
                </div>
