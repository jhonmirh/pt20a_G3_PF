    ...
    <div className="flex items-center justify-center h-screen">
      {modalVisible && (
        <Modal title="Pago Exitoso" onClose={handleCloseModal}>
          ...
          <button
            onClick={handleCloseModal}
            className="bg-gray-900 text-white w-full px-4 py-2 rounded hover:bg-gray-700 transition-all mt-4"
          >
            Cerrar
          </button>
        </Modal>
...
// Esto resuelve el problema de prerenderizado en Vercel
export async function getServerSideProps() {
  return {
    props: {}, // Solo retorna props vacías porque todo el trabajo lo hace el cliente
  };
}
